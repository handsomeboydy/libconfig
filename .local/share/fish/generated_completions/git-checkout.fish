...
complete -c git-checkout -l no-guess --description 'Do not attempt to create a branch if a remote tracking branch of the same nam…'
complete -c git-checkout -l overlay --description 'In the default overlay mode, git checkout never removes files from the index …'
complete -c git-checkout -l no-overlay --description '<branch>.'
