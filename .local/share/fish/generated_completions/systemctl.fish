...
complete -c systemctl -s T -l show-transaction --description 'When enqueuing a unit job (for example as effect of a systemctl start invocat…'
...
complete -c systemctl -l firmware-setup --description 'When used with the reboot command, indicate to the system\\*(Aqs firmware to r…'
complete -c systemctl -l boot-loader-menu --description 'When used with the reboot command, indicate to the system\\*(Aqs boot loader t…'
complete -c systemctl -l boot-loader-entry --description 'When used with the reboot command, indicate to the system\\*(Aqs boot loader t…'
